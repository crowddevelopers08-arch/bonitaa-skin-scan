...
export function SkinResultsView({ formData, capturedImage, onBack }: SkinResultsViewProps) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#080b12", color: "#f2f0eb", padding: "0" }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1180px", margin: "0 auto", padding: "32px 16px 60px" }}>
          ...
          {promoImages.length > 0 && (
            ...
            >
              <div style={{ marginBottom: "14px" }}>
                <p style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#ddb95a", marginBottom: "8px" }}>
                  Recommended Care Options
                </p>
                <p style={{ color: "#8a8a8a", fontSize: "0.9rem", lineHeight: 1.6 }}>
                  These in-clinic treatments may complement your scan results.
                </p>
              </div>
